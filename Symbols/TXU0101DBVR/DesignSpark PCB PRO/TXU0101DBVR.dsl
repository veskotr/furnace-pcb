...
(library Library_1
	...
	(compDef "TXU0101DBVR" (originalName "TXU0101DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "OE") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "BY") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/lit/ds/symlink/txu0101.pdf?ts=1669130963626&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTXU0101")
		(attr "Height" "1.45 mm")
	)
