...
//17436154/1888639/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TXU0101DBVR" (originalName "TXU0101DBVR")
	...
	(compDef "TXU0101DBVR" (originalName "TXU0101DBVR") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "OE") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "BY") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TXU0101DBVR"))
		...
		(attr "Mouser Part Number" "595-TXU0101DBVR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TXU0101DBVR?qs=IPgv5n7u5QaPPuDmRaldJw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TXU0101DBVR")
		(attr "Description" "Translation - Voltage Levels Single channel fixed-direction level shifter")
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/txu0101.pdf?ts=1669130963626&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FTXU0101")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "TXU0101DBVR.stp")
